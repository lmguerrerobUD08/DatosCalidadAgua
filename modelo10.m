...
x = [datosdouble(:,2:4) ndwi]';
% x = [datosdouble(:,[2:4,13]) ndwi]'; %cambiar para el analisis de clima
...
xnew = [vdatos(:,2:4) ndwiretroc]';
tnew = net([vdatos(:,2:4) ndwiretroc]');
